...
const Blogcard = (props) => {
    ...
    const apiURL = import.meta.env.MODE === "development" ?'http://localhost:3000':'/';
    return (
        <div className='bg-white shadow-md overflow-hidden rounded-xl'>
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="w-full h-[250px] bg-no-repeat bg-cover bg-center" style={{backgroundImage:`url(${blogdata.image})`}}>
